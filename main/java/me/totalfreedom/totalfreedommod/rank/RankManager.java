...
public class RankManager extends FreedomService
{
    ...
    public RankBase getDisplay(CommandSender sender)
    {
        ...
        return rank;
         ...
         if (MainConfig.get(ConfigEntry.SERVER_DEVS, List.class).contains(player.getName()))
        {
            return Title.DEVELOPER;
        }
        ...
        return rank;
         ...
         if (MainConfig.get(ConfigEntry.SERVER_EXEC, List.class).contains(player.getName()))
        {
            return Title.EXEC;
        }
